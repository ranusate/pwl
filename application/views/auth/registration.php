                ...
                <div class="row">
                    <div class="col-lg">
                        <div class="p-5">
                            ...
                            <form class="user" method="POST" action="<?= base_url('au/registration'); ?>">
                            ...
                            <div class="text-center">
                                <a class="small" href="<?= base_url('au/forgotPassword'); ?>">Forgot Password?</a>
                            </div>
                            <div class="text-center">
                                <a class="small" href="<?= base_url('au'); ?>">Already have an account? Login!</a>
                            </div>
                        </div>
                    </div>
                </div>
