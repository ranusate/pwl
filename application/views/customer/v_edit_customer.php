            ...
            <div class="card-body">
                ...
                <form method="post" class="form" action="<?= base_url('customer/proses') ?>">
                    <div class="form-group">
                        ...
                        <input type="text" value="<?= $row->nama ?>" class="form-control textbox" id="nama" name="nama" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="no_tlpn" value="<?= $row->no_tlpn ?>" class="form-control textbox" id="no_tlpn" required>
                        <i class="form-control-feedback"></i>
                        <span class="text-danger"></span>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" value="<?= $row->alamat ?>" name="alamat" class="form-control textbox">
                        <i class="form-control-feedback"></i>
                        <span class="text-danger"></span>
                        </input>
                    </div>
                    <div class="card-footer">
                        <a href="<?= site_url(array("customer")) ?>" class="btn btn-danger btn-xs">
                            Cancel
                        </a>
