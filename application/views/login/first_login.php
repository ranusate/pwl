...
<head>
	...
	<title>POS Kasir| Ubah Password</title>

	<!-- Font Awesome -->
	<link rel="stylesheet" href="<?= base_url() . 'assets/' ?>pt/plugins/fontawesome-free/css/all.min.css">
							...
							<div class="col-lg">
								<div class="p-5">
									<div class="text-center">
										<h4 class="login-box-msg">Silahkan Masukkan Password baru anda</h4>
									</div>
