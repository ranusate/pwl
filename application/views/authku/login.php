                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post" action="<?= site_url('auth/proses_login'); ?>">
                                    <!-- <form action=""> -->
                                        ...
                                        <button type="submit" id="btn-login" name="login" class="btn btn-primary btn-user btn-block">
                                            Login
                                        </button>
                                        <hr>
...
$(function () {
	$("#btn-login").on("click", function () {
		...
		swal.fire({
			...
			imageUrl: '<?= base_url() ?>' + "images/duar.gif",
