            ...
            <div class="card-body">
                <form method="post" class="form" action="<?= base_url('stock/proses') ?>">
                    ...
                    <!-- <div class="form-group input-group">
                        <input type="text" value="" class="form-control" id="barcode" name="barcode"
                    ...
                    <div class="form-group">
                        ...
                        <select name="id_barang" class="js-example-placeholder-single js-states form-control" id="select-barang">
                    ...
                    <div class="card-footer">
                        ...
                        <button type="submit" name="out_add" class="btn btn-success btn-flat">Tambah</button>
                    </div>
                </form>
            </div>
        </div>
